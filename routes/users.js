...
const { editProfile, getUser, deleteUser, updateUser, editUser, createUser } = require("../controllers/userControllers");
...
router.get("/profile", authMiddleware, checkRol(["user", "admin"]), editProfile); // ruta para renderizar la vista  files
